...
style="max-width: 280px;">
    ...
    <div class="translation-all-3 mdl-card mdl-cell mdl-shadow--2dp mdl-cell--4-col hover-shadow--4dp
        ...
        <div class="mdl-card__title" style="border-bottom: 1px solid gainsboro">
            <h2 style="font-size: 16px" class="mdl-card__title-text mdl-typography--font-bold color-text-block-second">
                最近回复</h2>
        </div>
...
style="overflow: hidden;white-space: nowrap;font-size: 14px;text-indent: 1em;
